...
class JobCtrl(flask_restful.Resource):
    ...
    @swagger.operation(
        ...
        parameters=[{
            ...
            "name": "priority",
            "description": "低级: -1, 普通: 0, 高级: 1, 优先: 2",
            "required": False,
            "paramType": "form",
            "dataType": 'int'
        }, {
...
class JobDetailCtrl(flask_restful.Resource):
    @swagger.operation(
        ...
        parameters=[{
            ...
            "name": "enabled",
            "description": "未激活:-1 / 已激活:0, 默认: 0",
            "required": False,
            "paramType": "form",
            "dataType": 'int'
        }, {
            "name": "status",
            "description": "如果设置'run'，作业马上执行",
            "required": False,
            "paramType": "form",
            "dataType": 'int'
        }
